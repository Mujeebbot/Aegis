...
const DOCUMENTED_BUT_UNUSED = new Set([
  ...
  // Frontend-only: read via import.meta.env in frontend/src/contracts.ts, not
  // process.env, so this backend-source scan can never see them as "used".
